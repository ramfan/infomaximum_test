...
const tagP = {display: 'flex', paddingTop: '2%', paddingLeft: '5%'};
const tagPForEdit = {display: 'flex', paddingTop: '1%', paddingLeft: '5%', width: '100%'};

class  Error extends Component{
    render(){
        const {theme, textVal} = this.props;
        const style = {
        ...
        return (
            <div style={style}>
                ...
                <p style={this.props.edit?tagPForEdit: tagP}>{textVal}</p>
            </div>
        );
    }
