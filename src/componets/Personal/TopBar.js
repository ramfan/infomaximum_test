...
const RowStyle = {width: '97%', height: '40px', background: '#ffffff', padding: '1%', position: 'absolute', zIndex: 99};
const ColStyle = {width: '100%', height: '25px', paddingTop: '0.22%'};
const DivStyle = {color: '#535374',fontSize: '12px',paddingTop: '1%'};
const SvgStyle = {
...
class TopBar extends Component {
    ...
    render() {
        ...
        return (
                <Row justify="start" style={RowStyle} onClick={this.toggleMenu}>
                       {/*==================================================
                    ...
                    <div style={SvgStyle}>
                     ...
                     <Col sm={1} style={ColStyle} >
                        <div style={DivStyle} ><strong>Меню</strong></div>
                     </Col>
                 </Row>
